...
public class SeekBarDialogPreference extends
	...
	protected View onCreateDialogView() {
		...
		View view = layoutInflater.inflate(
			R.layout.activity_seekbar_pref_dialog, null);

		seekBar = (SeekBar)view.findViewById(R.id.seekbarPrefDialogSeekbar);
		valueText = (TextView)view.findViewById(R.id.seekbarPrefDialogValueText);
